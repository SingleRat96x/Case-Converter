...
(function () {
  ...
  if (gaTrackingId && typeof gtag === 'function') {
    console.log(
      'External GA Config: Configuring with ID ' +
        gaTrackingId +
        ' for path ' +
    ...
    if (typeof gtag !== 'function') {
      console.error(
        'External GA Config: gtag function is not defined. Ensure main gtag.js library (gtag-manager) is loaded before this script.'
      );
    }
  }
})();
