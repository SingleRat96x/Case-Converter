...
export async function generateToolMetadata(
  ...
  const metadata: Metadata = {
    ...
    openGraph: {
      ...
      alternateLocale: locale === 'en' ? ['ru_RU', 'de_DE'] : locale === 'ru' ? ['en_US', 'de_DE'] : ['en_US', 'ru_RU'],
      url: canonicalUrl,
...
function generateGenericMetadata(options: { locale: Locale; pathname: string }): Metadata {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      locale: validLocale === 'en' ? 'en_US' : validLocale === 'ru' ? 'ru_RU' : 'de_DE',
      alternateLocale: validLocale === 'en' ? ['ru_RU', 'de_DE'] : validLocale === 'ru' ? ['en_US', 'de_DE'] : ['en_US', 'ru_RU'],
      url: canonicalUrl,
      siteName: "Text Case Converter",
    },
    twitter: {
