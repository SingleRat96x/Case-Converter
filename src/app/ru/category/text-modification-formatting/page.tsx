...
const textModificationTools = [
  ...
  },
  {
    ...
    description: 'Добавляйте настраиваемые номера строк к тексту с множеством форматов и опций',
    icon: '🔢',
    href: '/ru/tools/add-line-numbers-to-text'
  },
  {
    id: 'add-prefix-and-suffix-to-lines',
    title: 'Добавить Префикс и Суффикс к Строкам',
    description: 'Добавляйте пользовательский префикс и суффикс к каждой строке с умной обработкой пустых строк',
    icon: '🔗',
    href: '/ru/tools/add-prefix-and-suffix-to-lines'
  }
];
