    ...
    <div className="max-w-[900px] mx-auto space-y-4">
            ...
            <div>
              <label className="cursor-pointer">
                <span className="text-lg font-medium text-gray-900 dark:text-gray-50">
                  Upload a JPG image to convert to WEBP
                </span>
                <input
                  ref={fileInputRef}
                  type="file"
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  WEBP typically achieves 25-35% smaller file sizes than JPG
                </div>
              </div>
              {fileInfo && (
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
        ...
        <div className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
          ...
          <div>• Ideal for web optimization and faster page loading</div>
        </div>
      </div>
    </div>
  );
