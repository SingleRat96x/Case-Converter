  ...
  return (
    <div className="max-w-[900px] mx-auto space-y-4">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
        <h3 className="text-sm font-medium text-gray-900 dark:text-gray-50 mb-2">About PNG to WEBP Conversion</h3>
        <div className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
          ...
          <div>• Supported by all modern browsers (Chrome, Firefox, Safari, Edge)</div>
