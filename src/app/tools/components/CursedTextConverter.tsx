    ...
    <div className="max-w-[900px] mx-auto space-y-4">
      ...
      <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-medium text-gray-900 dark:text-gray-50">Cursed Text Settings</h3>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Input */}
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-900 dark:text-gray-50">Normal Text</label>
          <textarea
        ...
        {/* Output */}
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-900 dark:text-gray-50">Cursed Text (Zalgo)</label>
          <textarea
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
        <h3 className="text-sm font-medium text-gray-900 dark:text-gray-50 mb-2">⚠️ Usage Warning</h3>
        <div className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
          <div>• Cursed text uses Unicode combining characters that may cause display issues</div>
          <div>• Some platforms may not render cursed text correctly</div>
          <div>• Use responsibly - excessive cursed text may be hard to read</div>
